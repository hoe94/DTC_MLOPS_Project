...
if __name__ == "__main__":
    ...
    fe_categorical_columns_list = ['Credit_Mix', 'Payment_of_Min_Amount', 'Payment_Behaviour', 'Credit_Score']

    normalization_columns_list = ['Occupation', 'Credit_Mix', 'Payment_of_Min_Amount', 'Payment_Behaviour',	'Month_num']
    top_N_num = 5

    df = FE_numeric_main(df, fe_numerical_columns_list)
